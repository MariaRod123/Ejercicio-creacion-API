package com.sofka.LibretaPrueba.controller;
import com.sofka.LibretaPrueba.domain.Contacto;
import com.sofka.LibretaPrueba.domain.Telefono;
import com.sofka.LibretaPrueba.services.LibretaService;
import com.sofka.LibretaPrueba.utility.Response;
...
public class LibretaController {
     ...
     * @return Objeto Response en formato JSON
     */
    @GetMapping(path = "/api/v1/search/contacto/{dataToSearch}")
    public ResponseEntity<Response> searchContactoByNombreOrApellido(
     ...
     * @return Objeto Response en formato JSON
     */
    @PatchMapping(path = "/api/v1/contacto/{id}/nombre")
     ...
     * @return Objeto Response en formato JSON
     */
    @PatchMapping(path = "/api/v1/contacto/{id}/apellido")
    public ResponseEntity<Response> updateApellidoFromContacto(
        ...
        response.restart();
        try {
            response.data = libretaService.updateApellido(id, contacto);
            httpStatus = HttpStatus.OK;
        } catch (DataAccessException exception) {
            getErrorMessageForResponse(exception);
        } catch (Exception exception) {
